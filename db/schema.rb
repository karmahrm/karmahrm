...
ActiveRecord::Schema.define(version: 20160327044047) do
  ...
  add_index "comments", ["origin_type", "origin_id"], name: "index_comments_on_origin_type_and_origin_id", using: :btree
  ...
  add_index "notifications", ["origin_type", "origin_id"], name: "index_notifications_on_origin_type_and_origin_id", using: :btree
